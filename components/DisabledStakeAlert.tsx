...
export function getDisabledStakeButtonReason(
  ...
  if (!opStatus.bakerAcceptsStaking)
    ...
    reason =
      `Before staking with a new baker, you must wait for your current unstake operations to be finalized. The unstaking process takes ${process.env.NEXT_PUBLIC_UNSTAKE_DAYS} days, and can be monitored via the main dashboard.`
  return reason
}
